...
def staticify_drop_map(map_id)
  ...
  table = map_id > 100 ? DropRecordWinter2017 : DropRecord
  table_name = map_id > 100 ? "drop_records_winter2017" : "drop_records"
...
def staticify_drop_ship()
  table = [DropRecord, DropRecordWinter2017]
  table_name = ["drop_records", "drop_records_winter2017"]
