...
$event_maps = [381, 382, 383]

def staticify_drop_map(map_id)
  levels = map_id > 100 ? [3, 2, 1] : [0]
  table = map_id > 100 ? DropRecordSpring2017 : DropRecord
  table_name = map_id > 100 ? "drop_records_spring2017" : "drop_records"
...
def staticify_drop_ship()
  table = [DropRecord, DropRecordSpring2017]
  table_name = ["drop_records", "drop_records_spring2017"]
