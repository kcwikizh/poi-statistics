...
#      :name => drop_pool_name,
      ...
      if x == 486||x==516||x==561||x==596
        ...
        '驱逐舰'
      elsif x == 483 || x==494 || x==162 || x==517 || x==518 || x==524||x==491||x==525||x==535||x==540||x==493||x==552||x==531||x==551||x==565||x==495||x==585||x==611||x==584
        '其他'
  ...
  when 475
    ...
    when 492
      ...
      when 515
        ...
        info = case i
          when 486, 452,423,473,457,471,472,456,449,485,481,483,494,480,479,491,444,448,525,535,439,475,492,515,519,552,474,484,531,511,516,433,440,527,551,574,565,495,528,532,562,585,534,544,561,596,549,611,614,583,584,604,595
            ship
          else
...
pool = {map: [461,462,463,464], name: 'test'}
